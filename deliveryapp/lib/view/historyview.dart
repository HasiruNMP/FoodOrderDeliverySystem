...
//+====
class HistoryView1 extends StatefulWidget {
  const HistoryView1({Key? key}) : super(key: key);

  @override
  _HistoryView1State createState() => _HistoryView1State();
}

class _HistoryView1State extends State<HistoryView1> {
  @override
  Widget build(BuildContext context) {
